...
import type { Tab, SubTab, Library, LibraryItem, AppSettings, TMDBResult } from './types'
...
interface AppState {
  ...
  libSearch: string
  setLibSearch: (q: string) => void

  searchQuery: string
  searchResults: TMDBResult[]
  isSearching: boolean
  setSearchQuery: (q: string) => void
  setSearchResults: (r: TMDBResult[]) => void
...
export const useStore = create<AppState>((set, get) => ({
  ...
  libSearch: '',
  setLibSearch: (q) => set({ libSearch: q }),
