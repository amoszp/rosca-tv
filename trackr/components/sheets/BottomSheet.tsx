...
const STATUS_ACTIVE: Record<Status, React.CSSProperties> = {
  ...
  watched:  { background: 'rgba(100,116,139,0.18)', color: '#94a3b8', borderColor: 'rgba(100,116,139,0.38)', fontWeight: 700 },
}
...
export default function BottomSheet() {
  ...
  useEffect(() => {
    if (!sheet) { setLocalItem(null); setProviders([]); setSeasons([]); setIsDirty(false); setShowDirty(false); return }
  ...
  /* FIX: cancel only hides the modal — drawer stays open, edits intact */
